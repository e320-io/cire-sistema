...
function AgendaCalendar({session,onVerFicha,isAdmin}){
  ...
  return(
    <div style={{display:"flex",flexDirection:"column",height:"calc(100vh - 64px)",background:"#fff",color:"#111"}}>
      ...
      {detalle&&<div className="overlay" onClick={()=>setDetalle(null)}><div className="glass" style={{width:400,padding:"26px",borderColor:`${colorCita(detalle)}44`,color:"#fff",display:"flex",flexDirection:"column",maxHeight:"90vh"}} onClick={e=>e.stopPropagation()}>
        ...
        <div style={{flex:1,overflowY:"auto",marginBottom:"12px"}}><div style={{display:"flex",flexDirection:"column",gap:"9px",background:"rgba(0,0,0,0.3)",borderRadius:"10px",padding:"14px",marginBottom:"12px"}}>
